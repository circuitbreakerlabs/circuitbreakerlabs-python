...
T = TypeVar("T", bound="SingleTurnRerunOpenAiFinetuneRequest")


@_attrs_define
class SingleTurnRerunOpenAiFinetuneRequest:
    """
    Attributes:
        threshold (float):
        variations (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        single_turn_rerun_open_ai_finetune_request = cls(
            threshold=threshold,
            variations=variations,
            maximum_iteration_layers=maximum_iteration_layers,
            model_name=model_name,
        ...
        single_turn_rerun_open_ai_finetune_request.additional_properties = d
        return single_turn_rerun_open_ai_finetune_request
