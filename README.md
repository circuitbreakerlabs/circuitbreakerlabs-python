...
```python
from circuit_breaker_labs_api_client import Client
...
```python
from circuit_breaker_labs_api_client import AuthenticatedClient
...
```python
from circuit_breaker_labs_api_client.models import MyDataModel
from circuit_breaker_labs_api_client.api.my_tag import get_my_data_model
from circuit_breaker_labs_api_client.types import Response
...
1. Any endpoint which did not have a tag will be in
   `circuit_breaker_labs_api_client.api.default`
...
1. Publish the client with `poetry publish --build -r <your-repository-name>`
